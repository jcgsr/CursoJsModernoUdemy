...
/* harmony import */ var _mudules_formGeraSenha__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mudules/formGeraSenha */ "./src/mudules/formGeraSenha.js");
...
Object(_mudules_formGeraSenha__WEBPACK_IMPORTED_MODULE_0__["default"])();

/***/ }),

/***/ "./src/mudules/formGeraSenha.js":
/*!**************************************!*\
  !*** ./src/mudules/formGeraSenha.js ***!
  \**************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _geradores__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./geradores */ "./src/mudules/geradores.js");

var senhaGerada = document.querySelector('.senha-gerada');
var qntC = document.querySelector('.qnt-c');
var chkMaius = document.querySelector('.chk-M');
var chkMinus = document.querySelector('.chk-m');
var chkN = document.querySelector('.chk-n');
var chkS = document.querySelector('.chk-s');
...
function gera() {
  var senha = Object(_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qntC.value, chkMaius.checked, chkMinus.checked, chkN.checked, chkS.checked);
  return senha || 'Nada selecionado';
}

/***/ }),

/***/ "./src/mudules/geradores.js":
/*!**********************************!*\
  !*** ./src/mudules/geradores.js ***!
  \**********************************/
/*! exports provided: default */
...
var gera_n = function gera_n() {
  return String.fromCharCode(rand(48, 58));
};

var s = ',.;~^[]{}()_-=§!@#$%*£¢|';

var gera_s = function gera_s() {
  return s[rand(0, s.length)];
};

function geraSenha(qnt, maius, minus, num, simb) {
  var senhaArray = [];
  qnt = Number(qnt);
